...
public class AsmetaLParser extends AbstractFSTParser implements AsmetaLParserConstants {
  ...
  final public FSTInfo MainMacroDeclaration(boolean inTerminal) throws ParseException {
    ...
    n = MacroDeclaration(true);
                                                                        replaceName("MacroDeclaration", n);
                                                                                                              replaceName(n);
                                                                                                                                {if (true) return productionEndTerminal("RuleDeclaration","{MacroDeclaration}","{MacroDeclaration}","AsmetaLRuleRefinement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ImportClause(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_14(7)) {
      ...
      ;
                                                                                                                      ...
                                                                                                                      {if (true) return productionEndTerminal("ImportClause","{MOD_ID}","{MOD_ID}","AsmetaLImportOverriding","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    while (true) {
      ...
      n = AgentInitialization(true);
                                                                                                                                                                                    replaceName(n);
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        {if (true) return productionEndTerminal("Initialization","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo FunctionInitialization(boolean inTerminal) throws ParseException {
    ...
    n = Term(true);
                                                                                                                                                         replaceName(n);
                                                                                                                                                                           {if (true) return productionEndTerminal("FunctionInitialization","{ID_FUNCTION}","{ID_FUNCTION}","AsmetaLFunctionConjunction","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo Definition(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_26(7)) {
      n = DomainDefinition(true);
                                  replaceName("DomainDefinition", n);
                                                                        replaceName(n);
                                                                                          {if (true) return productionEndTerminal("DomainDefinition","{DomainDefinition}","{DomainDefinition}","Replacement","Default",first,token);}
    } else if (jj_2_27(7)) {
      n = FunctionDefinition(true);
                                    replaceName("FunctionDefinition", n);
                                                                            replaceName(n);
                                                                                              {if (true) return productionEndTerminal("FunctionDefinition","{FunctionDefinition}","{FunctionDefinition}","AsmetaLFunctionConjunction","Default",first,token);}
    } else if (jj_2_28(7)) {
      n = RuleDeclaration(true);
                                 replaceName("RuleDeclaration", n);
                                                                      replaceName(n);
                                                                                        {if (true) return productionEndTerminal("RuleDeclaration","{RuleDeclaration}","{RuleDeclaration}","AsmetaLRuleRefinement","Default",first,token);}
    } else if (jj_2_29(7)) {
      n = Constraint(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("Definition4","{TOSTRING}","{TOSTRING}","Replacement","Default",first,token);}
    } else if (jj_2_30(7)) {
      n = Property(true);
                          replaceName(n);
                                            {if (true) return productionEndTerminal("Definition5","{TOSTRING}","{TOSTRING}","Replacement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo Constraint(boolean inTerminal) throws ParseException {
                                           Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_31(7)) {
      n = InvarConstraint(inTerminal);
                                       replaceName(n);
                                                         {if (true) return productionEndNonTerminal("Constraint1","-","-");}
    } else if (jj_2_32(7)) {
      n = FairnessConstraint(inTerminal);
                                          replaceName(n);
                                                            {if (true) return productionEndNonTerminal("Constraint2","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo FairnessConstraint(boolean inTerminal) throws ParseException {
                                                   Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_33(7)) {
      n = JusticeConstraint(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("FairnessConstraint1","-","-","Replacement","Default",first,token);}
    } else if (jj_2_34(7)) {
      n = CompassionConstraint(true);
                                      replaceName(n);
                                                        {if (true) return productionEndTerminal("FairnessConstraint2","-","-","Replacement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo JusticeConstraint(boolean inTerminal) throws ParseException {
                                                  Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(JUSTICE);
    n = Term(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("JusticeConstraint","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo CompassionConstraint(boolean inTerminal) throws ParseException {
                                                     Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(COMPASSION);
    n = Term(true);
                                   replaceName(n);
                                                     {if (true) return productionEndTerminal("CompassionConstraint","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo InvarConstraint(boolean inTerminal) throws ParseException {
                                                Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(INVAR);
    n = Term(true);
                              replaceName(n);
                                                {if (true) return productionEndTerminal("InvarConstraint","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    if (jj_2_35(7)) {
      n = Invariant(true);
                           replaceName("Invariant", n);
                                                          replaceName(n);
                                                                            {if (true) return productionEndTerminal("Property1","Invariant{Invariant}","Invariant{Invariant}","Replacement","Default",first,token);}
    } else if (jj_2_36(7)) {
      n = TemporalProperty(true);
                                  replaceName("TemporalProperty", n);
                                                                        replaceName(n);
                                                                                          {if (true) return productionEndTerminal("Property2","TemporalProperty{TemporalProperty}","TemporalProperty{TemporalProperty}","Replacement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo TemporalProperty(boolean inTerminal) throws ParseException {
                                                 Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_37(7)) {
      n = CTLSpec(true);
                         replaceName(n);
                                           {if (true) return productionEndTerminal("TemporalProperty1","-","-","Replacement","Default",first,token);}
    } else if (jj_2_38(7)) {
      n = LTLSpec(true);
                         replaceName(n);
                                           {if (true) return productionEndTerminal("TemporalProperty2","-","-","Replacement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo CTLSpec(boolean inTerminal) throws ParseException {
                                        Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    ...
    n = Term(true);
                                                                       replaceName(n);
                                                                                         {if (true) return productionEndTerminal("CTLSpec","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo LTLSpec(boolean inTerminal) throws ParseException {
                                        Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    ...
    n = Term(true);
                                                                       replaceName(n);
                                                                                         {if (true) return productionEndTerminal("LTLSpec","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo ID_CTL(boolean inTerminal) throws ParseException {
                                       Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(ID_CTL);
                  {if (true) return productionEndTerminal("ID_CTL","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo ID_LTL(boolean inTerminal) throws ParseException {
                                       Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(ID_LTL);
                  {if (true) return productionEndTerminal("ID_LTL","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo FunctionDefinition(boolean inTerminal) throws ParseException {
    ...
    n = Term(true);
                                                                                                                                                         replaceName(n);
                                                                                                                                                                           {if (true) return productionEndTerminal("FunctionDefinition","{ID_FUNCTION}","{ID_FUNCTION}","AsmetaLFunctionConjunction","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
    ...
    if (jj_2_42(7)) {
      ...
      n = TurboDeclaration(true);
                                  replaceName("TurboDeclaration", n);
                                                                        replaceName(n);
                                                                                          {if (true) return productionEndTerminal("RuleDeclaration","{TurboDeclaration}","{TurboDeclaration}","AsmetaLRuleRefinement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo NamedInvariant(boolean inTerminal) throws ParseException {
    ...
    n = Term(true);
                                                                                                                                           replaceName(n);
                                                                                                                                                             {if (true) return productionEndTerminal("NamedInvariant","-","{ID_AXIOM}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo ID_INVARIANT(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    n = ID_Axiom(true);
                          replaceName("ID_Axiom", n);
                                                        replaceName(n);
                                                                          {if (true) return productionEndTerminal("ID_INVARIANT","-","{ID_Axiom}","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }

  final public FSTInfo ID_Axiom(boolean inTerminal) throws ParseException {
                                         Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    jj_consume_token(ID_AXIOM);
                    {if (true) return productionEndTerminal("ID_Axiom","-","-","Replacement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private boolean jj_3R_155() {
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_179()) { jj_scanpos = xsp; break; }
    }
    return false;
  }
  ...
  final private JJCalls[] jj_2_rtns = new JJCalls[238];
