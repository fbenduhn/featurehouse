/* Generated By:JavaCC: Do not edit this line. AsmetaLParser_rules.java */
...
public class AsmetaLParser_rules extends AbstractFSTParser implements AsmetaLParser_rulesConstants {
        public AsmetaLParser_rules(){}
  ...
  final public FSTInfo RuleDeclaration(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_35(7)) {
      ...
      n = MacroDeclaration(inTerminal);
                                                      replaceName("MacroDeclaration", n);
                                                                                            replaceName(n);
                                                                                                              {if (true) return productionEndNonTerminal("MacroDeclaration","{MacroDeclaration}","{MacroDeclaration}");}
    } else if (jj_2_36(7)) {
      if (jj_2_34(7)) {
        jj_consume_token(FINALRULE);
      } else {
      ...
      n = TurboDeclaration(inTerminal);
                                                      replaceName("TurboDeclaration", n);
                                                                                            replaceName(n);
                                                                                                              {if (true) return productionEndNonTerminal("TurboDeclaration","{TurboDeclaration}","{TurboDeclaration}");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo MacroDeclaration(boolean inTerminal) throws ParseException {
    ...
    n = ID_RULE(inTerminal);
                                                replaceName(n);
    if (jj_2_38(7)) {
      n = TermInDomainList(inTerminal);
                                                                                                  replaceName(n);
    } else {
      ;
    }
    ...
    n = Rule(inTerminal);
                                                                                                                                            replaceName(n);
                                                                                                                                                              {if (true) return productionEndNonTerminal("MacroDeclaration","Macy","Macy");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo CTLSPECS(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_46(7)) {
      ...
      n = Term(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("CTLSPECS1","{TOSTRING}","{TOSTRING}","AsmetaLCTLSPECSOverriding","Default",first,token);}
    } else if (jj_2_47(7)) {
      jj_consume_token(LTLSPEC);
      n = Term(true);
                                replaceName(n);
                                                  {if (true) return productionEndTerminal("CTLSPECS2","{TOSTRING}","{TOSTRING}","AsmetaLCTLSPECSOverriding","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo Term(boolean inTerminal) throws ParseException {
    ...
    if (jj_2_94(7)) {
      n = Expression(true);
                            replaceName(n);
                                              {if (true) return productionEndTerminal("Term1","-","{TOSTRING}","Replacement","Default",first,token);}
    } else if (jj_2_95(7)) {
      n = ExtendedTerm(true);
                              replaceName(n);
                                                {if (true) return productionEndTerminal("Term2","-","{TOSTRING}","Replacement","Default",first,token);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo CaseTerm(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(END_SWITCH);
                                                                                                                                                                            {if (true) return productionEndTerminal("CaseTerm","{Term}","{Term}","AsmetaLSwitchRefinement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo Rule(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_200(7)) {
      n = BasicRule(inTerminal);
                                 replaceName(n);
                                                   {if (true) return productionEndNonTerminal("Rule1","212","212");}
    } else if (jj_2_201(7)) {
      n = TurboRule(inTerminal);
                                 replaceName(n);
                                                   {if (true) return productionEndNonTerminal("Rule2","212","212");}
    } else if (jj_2_202(7)) {
      n = UpdateRule(inTerminal);
                                  replaceName(n);
                                                    {if (true) return productionEndNonTerminal("Rule3","212","212");}
    } else if (jj_2_203(7)) {
      n = TurboReturnRule(inTerminal);
                                       replaceName(n);
                                                         {if (true) return productionEndNonTerminal("Rule4","212","212");}
    } else if (jj_2_204(7)) {
      n = TermAsRule(inTerminal);
                                  replaceName(n);
                                                    {if (true) return productionEndNonTerminal("Rule5","212","212");}
    } else if (jj_2_205(7)) {
      n = DerivedRule(inTerminal);
                                   replaceName(n);
                                                     {if (true) return productionEndNonTerminal("Rule6","212","212");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo DerivedRule(boolean inTerminal) throws ParseException {
     ...
     first=getToken(1); productionStart(inTerminal);
    if (jj_2_233(7)) {
      n = BasicDerivedRule(inTerminal);
                                        replaceName(n);
                                                          {if (true) return productionEndNonTerminal("DerivedRule1","-","-");}
    } else if (jj_2_234(7)) {
      n = TurboDerivedRule(inTerminal);
                                        replaceName(n);
                                                          {if (true) return productionEndNonTerminal("DerivedRule2","-","-");}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  final public FSTInfo BasicDerivedRule(boolean inTerminal) throws ParseException {
                                                 Token first=null,t;FSTInfo n;
     first=getToken(1); productionStart(inTerminal);
    n = CaseRule(inTerminal);
                                replaceName(n);
                                                  {if (true) return productionEndNonTerminal("BasicDerivedRule","-","-");}
    throw new Error("Missing return statement in function");
  }
  ...
  final public FSTInfo CaseRule(boolean inTerminal) throws ParseException {
    ...
    jj_consume_token(END_SWITCH);
                                                                                                                                                                            {if (true) return productionEndTerminal("CaseRule","{Term}","{Term}","AsmetaLSwitchRefinement","Default",first,token);}
    throw new Error("Missing return statement in function");
  }
  ...
  public AsmetaLParser_rulesTokenManager token_source;
  ...
  public AsmetaLParser_rules(CharStream stream) {
    token_source = new AsmetaLParser_rulesTokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public AsmetaLParser_rules(AsmetaLParser_rulesTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(AsmetaLParser_rulesTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
